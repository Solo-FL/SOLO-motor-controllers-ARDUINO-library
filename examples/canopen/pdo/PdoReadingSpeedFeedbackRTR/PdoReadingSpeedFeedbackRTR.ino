...
void setup()
{
  ...
  config.parameterName = SOLOMotorControllersCanopen::PdoParameterName::SPEED_FEEDBACK;
...
void loop()
{
  ...
  solo->SendPdoRtr(SOLOMotorControllersCanopen::PdoParameterName::SPEED_FEEDBACK);
  delay(50);
