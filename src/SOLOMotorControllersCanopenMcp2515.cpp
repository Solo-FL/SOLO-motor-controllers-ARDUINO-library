/**
 *******************************************************************************
 * @file    SOLOMotorControllersCanopenMcp2515.cpp
...
bool SOLOMotorControllersCanopenMcp2515::SetGuardTime(long guardtime, int &error)
{
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetDeviceAddress(unsigned char deviceAddress, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetCommandMode(SOLOMotorControllers::CommandMode mode, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetCurrentLimit(float currentLimit, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetTorqueReferenceIq(float torqueReferenceIq, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedReference(long speedReference, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetPowerReference(float powerReference, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::MotorParametersIdentification(SOLOMotorControllers::Action identification, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetOutputPwmFrequencyKhz(long outputPwmFrequencyKhz, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedControllerKp(float speedControllerKp, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedControllerKi(float speedControllerKi, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotorDirection(SOLOMotorControllers::Direction motorDirection, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotorResistance(float motorResistance, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotorInductance(float motorInductance, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotorPolesCounts(long motorPolesCounts, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetIncrementalEncoderLines(long incrementalEncoderLines, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedLimit(long speedLimit, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::ResetFactory(int &error)
{
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotorType(SOLOMotorControllers::MotorType motorType, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetControlMode(SOLOMotorControllers::ControlMode controlMode, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetCurrentControllerKp(float currentControllerKp, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetCurrentControllerKi(float currentControllerKi, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMagnetizingCurrentIdReference(float magnetizingCurrentIdReference, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetPositionReference(long positionReference, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetPositionControllerKp(float positionControllerKp, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetPositionControllerKi(float positionControllerKi, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::OverwriteErrorRegister(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetObserverGainDc(float observerGain, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetUartBaudrate(SOLOMotorControllers::UartBaudrate baudrate, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SensorCalibration(SOLOMotorControllers::PositionSensorCalibrationAction calibrationAction, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetEncoderHallCcwOffset(float encoderHallOffset, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetEncoderHallCwOffset(float encoderHallOffset, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedAccelerationValue(float speedAccelerationValue, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetSpeedDecelerationValue(float speedDecelerationValue, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetCanbusBaudrate(SOLOMotorControllers::CanbusBaudrate canbusBaudrate, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetAnalogueSpeedResolutionDivisionCoefficient(long divisionCoefficient, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileMode(SOLOMotorControllers::MotionProfileMode motionProfileMode, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileVariable1(float MotionProfileVariable1, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval bool 0 fail / 1 for success
 */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileVariable2(float MotionProfileVariable2, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileVariable3(float MotionProfileVariable3, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileVariable4(float MotionProfileVariable4, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval bool 0 fail / 1 for success
  */
bool SOLOMotorControllersCanopenMcp2515::SetMotionProfileVariable5(float MotionProfileVariable5, int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informatrionToRead[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
long SOLOMotorControllersCanopenMcp2515::GetGuardTime(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
long SOLOMotorControllersCanopenMcp2515::GetLifeTimeFactor(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
long SOLOMotorControllersCanopenMcp2515::GetProducerHeartbeatTime(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetDeviceAddress(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetPhaseAVoltage(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetPhaseBVoltage(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetPhaseACurrent(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetPhaseBCurrent(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetBusVoltage(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetDcMotorCurrentIm(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetDcMotorVoltageVm(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetSpeedControllerKp(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 16000
  */
float SOLOMotorControllersCanopenMcp2515::GetSpeedControllerKi(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetOutputPwmFrequencyKhz(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetCurrentLimit(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetQuadratureCurrentIqFeedback(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between -64 to 64
  */
float SOLOMotorControllersCanopenMcp2515::GetMagnetizingCurrentIdFeedback(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetMotorPolesCounts(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetIncrementalEncoderLines(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 16000
  */
float SOLOMotorControllersCanopenMcp2515::GetCurrentControllerKp(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 16000
  */
float SOLOMotorControllersCanopenMcp2515::GetCurrentControllerKi(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetBoardTemperature(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetMotorResistance(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetMotorInductance(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetSpeedFeedback(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetSpeedLimit(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 16000
  */
float SOLOMotorControllersCanopenMcp2515::GetPositionControllerKp(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 16000
  */
float SOLOMotorControllersCanopenMcp2515::GetPositionControllerKi(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetPositionCountsFeedback(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval long
  */
long SOLOMotorControllersCanopenMcp2515::GetErrorRegister(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval long
  */
long SOLOMotorControllersCanopenMcp2515::GetDeviceFirmwareVersion(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval long
  */
long SOLOMotorControllersCanopenMcp2515::GetDeviceHardwareVersion(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 32
  */
float SOLOMotorControllersCanopenMcp2515::GetTorqueReferenceIq(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval long between 0 to 30000
  */
long SOLOMotorControllersCanopenMcp2515::GetSpeedReference(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 32
  */
float SOLOMotorControllersCanopenMcp2515::GetMagnetizingCurrentIdReference(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetPositionReference(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 100 %
  */
float SOLOMotorControllersCanopenMcp2515::GetPowerReference(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0.01 to 1000
  */
float SOLOMotorControllersCanopenMcp2515::GetObserverGainDc(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::Get3PhaseMotorAngle(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetEncoderHallCcwOffset(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 1.0
  */
float SOLOMotorControllersCanopenMcp2515::GetEncoderHallCwOffset(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  */
float SOLOMotorControllersCanopenMcp2515::GetSpeedAccelerationValue(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float between 0 to 1600 Rev/S^2
  */
float SOLOMotorControllersCanopenMcp2515::GetSpeedDecelerationValue(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 * @retval long [kbits/s]
 */
long SOLOMotorControllersCanopenMcp2515::GetCanbusBaudrate(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval long
  */
long SOLOMotorControllersCanopenMcp2515::GetAnalogueSpeedResolutionDivisionCoefficient(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
 ...
 */
bool SOLOMotorControllersCanopenMcp2515::CommunicationIsWorking(int &error)
{
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
  float temperature = SOLOMotorControllersCanopenMcp2515::GetBoardTemperature(error);
  if (error == SOLOMotorControllers::Error::NO_ERROR_DETECTED)
  {
    return true;
  }
...
/**
  ...
  */
long SOLOMotorControllersCanopenMcp2515::GetEncoderIndexCounts(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float
  */
float SOLOMotorControllersCanopenMcp2515::GetMotionProfileVariable1(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float
  */
float SOLOMotorControllersCanopenMcp2515::GetMotionProfileVariable2(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float
  */
float SOLOMotorControllersCanopenMcp2515::GetMotionProfileVariable3(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float
  */
float SOLOMotorControllersCanopenMcp2515::GetMotionProfileVariable4(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
/**
  ...
  * @retval float
  */
float SOLOMotorControllersCanopenMcp2515::GetMotionProfileVariable5(int &error)
{
  uint8_t informationToSend[4] = {0x00, 0x00, 0x00, 0x00};
  uint8_t informationReceived[4] = {0x00, 0x00, 0x00, 0x00};
  error = SOLOMotorControllers::Error::NO_PROCESSED_COMMAND;
...
uint8_t SOLOMotorControllersCanopenMcp2515::Mcp2515ReadReceiveErrorCounter()
{
  return _MCP2515->Mcp2515ReadReceiveErrorCounter();
}
uint8_t SOLOMotorControllersCanopenMcp2515::Mcp2515ReadTransmitErrorCounter()
{
  return _MCP2515->Mcp2515ReadTransmitErrorCounter();
}

void SOLOMotorControllersCanopenMcp2515::GenericCanbusRead(uint16_t *_ID, uint8_t *_DLC, uint8_t *_Data)
{
  *_ID = 0;
  *_DLC = 0;
