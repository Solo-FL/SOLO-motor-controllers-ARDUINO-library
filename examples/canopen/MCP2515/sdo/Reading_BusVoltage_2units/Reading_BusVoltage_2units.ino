...
SOLOMotorControllersCanopenMcp2515 *SOLO_1;
SOLOMotorControllersCanopenMcp2515 *SOLO_2;
...
void setup()
{
  ...
  int chipSelectPin = 9;
  SOLO_1 = new SOLOMotorControllersCanopenMcp2515(0, chipSelectPin, baudrate, millisecondsTimeout); // Solo with 0 Device Address
  SOLO_2 = new SOLOMotorControllersCanopenMcp2515(6, chipSelectPin, baudrate, millisecondsTimeout); // Solo with 6 Device Address
}
