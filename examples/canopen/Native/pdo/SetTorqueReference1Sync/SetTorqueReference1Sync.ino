...
void setup()
{
  ...
  config.parameterName = SOLOMotorControllersCanopenNative::PdoParameterName::TORQUE_REFERENCE_IQ;
...
void loop()
{
  ...
  solo->SetPdoTorqueReferenceIq(1, errorSolo);
  ...
  getValue = solo->GetTorqueReferenceIq(errorSolo);
