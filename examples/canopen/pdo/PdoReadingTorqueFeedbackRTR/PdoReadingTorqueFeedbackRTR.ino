...
void setup()
{
  ...
  config.parameterName = SOLOMotorControllersCanopen::PdoParameterName::QUADRATURE_CURRENT_IQ_FEEDBACK;
...
void loop()
{
  ...
  solo->SendPdoRtr(SOLOMotorControllersCanopen::PdoParameterName::QUADRATURE_CURRENT_IQ_FEEDBACK);
  delay(50);
